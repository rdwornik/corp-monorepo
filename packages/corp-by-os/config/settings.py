...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_file=".env", env_file_encoding="utf-8", env_prefix="CORP_", extra="ignore"
    )
    ...
    onedrive_path: Path = Field(
        default=Path("C:/Users/1028120/OneDrive - Blue Yonder"), description="OneDrive root"
    )
    repo_path: Path = Field(
        default=Path("C:/Dev/corporate-os"), description="Repository root (outside OneDrive)"
    )
    ...
    graph_access_token: str | None = Field(default=None, alias="GRAPH_ACCESS_TOKEN")
    ...
    # FILE TYPES
    # ===================
    audio_extensions: list[str] = Field(default=[".mkv", ".m4a", ".mp3", ".wav", ".webm", ".mp4"])
