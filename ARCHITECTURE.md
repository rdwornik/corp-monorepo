...
- [Module Map](#module-map)
  ...
  - [schema/ -- Taxonomy & Validation](#schema----taxonomy--validation)
  - [extractor/ -- CKE (Knowledge Extraction Engine)](#extractor----cke-knowledge-extraction-engine)
  - [extraction/ -- Extraction Orchestration](#extraction----extraction-orchestration)
  - [ingest/ -- File Routing Pipeline](#ingest----file-routing-pipeline)
  - [ops/ -- Operational Database](#ops----operational-database)
  - [Other Modules](#other-modules)
- [Layer Boundaries & Invariants](#layer-boundaries--invariants-core)
  - [Layer Assignments](#layer-assignments)
  - [Runtime vs Static Depth](#runtime-vs-static-depth)
  - [Key Invariants](#key-invariants)
- [Database Schemas](#database-schemas)
  - [ops.db](#opsdb)
  - [index.db](#indexdb)
  - [overnight_state.db](#overnight_statedb)
- [Configuration Architecture](#configuration-architecture)
- [CLI Reference](#cli-reference)
  - [corp (main CLI -- 40+ commands)](#corp-main-cli----40-commands)
  - [Secondary CLIs](#secondary-clis)
- [Data Flow](#data-flow)
- [Design Patterns](#design-patterns)
- [Architecture Assessment](#architecture-assessment)
  - [What Works Well](#what-works-well)
  - [Violations & Technical Debt](#violations--technical-debt)
  - [Accepted Limitations](#accepted-limitations)
  - [OneDrive safety guards (hotfix 2026-04-21)](#onedrive-safety-guards-hotfix-2026-04-21)
- [Key conventions](#key-conventions)
- [Authority and governance](#authority-and-governance)
- [Validators and enforcement](#validators-and-enforcement)
