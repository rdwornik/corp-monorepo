...
from corp.safety.onedrive import PathTraversalError, guard_path
...
def _guard_onedrive(path: Path) -> None:
    ...
    call site below and test importers do not need to change.
    """
    guard_path(path, reason="cleanup/executor move")
